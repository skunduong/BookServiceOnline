...
class StorePostRequest extends FormRequest
{
    ...
    public function messages()
    {
        ...
        return [
            ...
            'introduce.max' => 'Thông tin không quá 255 kí tự',
            ...
            'republish.numeric' => 'Tái bản lần thứ phải là số',
            ...
            'images.mimes' => 'Ảnh bạn cung cấp không chính xác, chấp nhận JPEG, JPG, PNG',
        ];
    }
}
