@extends('layouts.master') @section('title') @endsection() @section('css')
<style type="text/css">
.pagination {
            ...
            <li class="product list-view">
                <div class="media">
                    ...
                    <div class="media-body media-middle">
                        <div class="row">
                            <div class="col-xs-12">
                                <span class="loop-product-categories"><a rel="tag" href="javascript:void(0)">Sách bán</a></span><a href="javascript:void(0)"><h3>{{ $book->name }}</h3>
...
{!! $books->links() !!} @endsection @section('sidebar') @include('particals.sidebar') @endsection @include('particals.contents') @endsection @section('footer') @include('particals.footer') @endsection() @push('scripts')
<script>
